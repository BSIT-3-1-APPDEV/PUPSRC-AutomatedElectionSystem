...
?>
  ...
  <body>
    ...
    <div class="m-4 d-flex justify-content-center">
      <div class="row" style="width: 100%;margin-top: 60px;margin-bottom: 60px; display: flex; justify-content: center; align-content: center;">
        <div class="col-lg-3 col-md-2 col-12">
          <div class="reminder">
            <br>
            <div class="main-color main-text ps-5 pe-4">
              <br>
              <div>
                <h4><strong>Settings & Privacy</strong></h4>
              </div>
              <br>
            </div>
          </div>
          ...
          <div class="reminder">
            <div class="vertical-icons">
              <i data-feather="user" class=" main-color white im-cust feather-2l"></i>
              <i data-feather="lock" class="white im-cust feather-2l"></i>
              <i data-feather="repeat" class="white im-cust feather-2l"></i>
            </div>
            <div class="font-weight1">
              <div class="pt-4">
                <div class="sub-head main-color ps-4 pe-4">
                  <h5>Information</h5>
                </div>
                <div class="main-color detail ps-4 pe-4 mt-1">
                  <p>See your account information like your email address and certificate of registration.</p>
                </div>
                <br>
                <div class="sub-head ps-4 pe-4">
                  <h5>Change Password</h5>
                </div>
                <div class="detail ps-4 pe-4 mt-1">
                  <p>Ensure your account's security by updating your password whenever you need.</p>
                </div>
                <br>
                <div class="sub-head ps-4 pe-4">
                  <h5>Transfer Org</h5>
                ...
                <div class="detail ps-4 pe-4 mt-1">
                  <p>Move your account to different organization upon transfer.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="reminder2">
            <div class="row">
              <div class="col">
                <div class="font-weight1">
                  <div class="pt-5"></div>
                  <div class="sub-head2 main-color ps-4 pe-4">
                    <h5><i data-feather="user" class="white im-cust feather-2l"></i>Information</h5>
                  </div>
                ...
                <div class="col" style="margin-top: -200px; margin-left: 350px;">
                ...
                <div class="container">
                  <span class="fs-7 ps-sm-2 spacing-5 fw-medium download">
