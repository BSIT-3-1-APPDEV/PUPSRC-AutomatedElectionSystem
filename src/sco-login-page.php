...
<head>
    ...
    <link rel="icon" href="images/logos/sco.png" type="image/png">
                ...
                <div>
                    <form action="" class="login-form">
                        ...
                        <div class="d-grid gap-2 mt-5 mb-4">
                            <a href="scoDashboard.html" class="btn login-sign-in-button" id="SCO-login-button" type="button">Sign In</a>
                        </div>

                        <p>Don’t have an account? <a href="scoRegistrationPage" id="scoSignUP">Sign Up</a></p>
