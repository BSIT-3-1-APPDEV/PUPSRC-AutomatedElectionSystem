...
<head>
    ...
    <link rel="icon" href="images/logos/elite.png" type="image/png">
    <title>ELITE Login</title>
</head>

<body class="login-body" id="ELITE-body">
    <div class="container-fluid">
        <div class="row">
            <div class="col login-left-section">
                <div class="organization-names">
                    <img src="images/logos/elite.png" class="img-fluid login-logo" alt="ELITE Logo">
                    <p>ELIGIBLE LEAGUE OF INFORMATION <br> TECHNOLOGY ENTHUSIASTS</p>
                    <h1 class="login-AES">AUTOMATED ELECTION SYSTEM</h1>

                    <div class="login-wave-footer" id="ELITE-wave">
                ...
                <div>
                    <form action="" class="login-form">
                        ...
                        <div class="d-grid gap-2 mt-5 mb-4">
                            <a href="eliteDashboard.html" class="btn login-sign-in-button" id="ELITE-login-button" type="button">Sign In</a>
                        </div>

                        <p>Don’t have an account? <a href="eliteRegistrationPage" id="eliteSignUP">Sign Up</a></p>
