...
include_once str_replace('/', DIRECTORY_SEPARATOR, __DIR__ . '/include/classes/File-utils.php');
...
require_once FileUtils::normalizeFilePath(__DIR__ . '/includes/classes/query-handler.php');
