                    ...
                    <div class="text-center">
                        ...
                        <div class="row">
                            <div class="col-md-12 pb-3">
                                ...
                                <p class="fw-medium spacing-5">Your password has been successfully updated! Please log in again.</p>
                                <button class="button-check text-white py-2 px-4" id="Home" style="background-color: #27AE60">
                                  <a class="custom-link" href="../src/setting-email-update.php"><b>Go to Log In</b></a>
                                </button>
                            </div>
                        </div>
                        <p>Redirecting to login in <b>10</b> seconds...</p>
                    </div>
                </div>
            </div>
        </div>
