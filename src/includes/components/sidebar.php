...
<nav class="sidebar">
	...
	<div class="menu-content">
		<ul class="menu-items ms-xl-1">
			...
			<li class="item">
				<div class="submenu-item <?php echo basename($_SERVER['PHP_SELF']) == 'manage-acc.php' ? 'active' : ''; ?>"
					data-bs-toggle="collapse" href="#manageAccounts" id="submenuToggle" data-bs-parent="false">
				...
				<ul class="menu-items submenu collapse" id="manageAccounts">
					<li class="item">
						<a href="manage-acc.php"
							class="<?php echo basename($_SERVER['PHP_SELF']) == 'manage-acc.php' ? 'active-sub fw-bold' : ''; ?>">Voters</a>
					</li>
					<li class="item">
					...
					<li class="item">
						<a href="admin-creation.php"
							class="<?php echo basename($_SERVER['PHP_SELF']) == 'add-committee.php' ? 'active-sub fw-bold' : ''; ?>">Add Committee</a>
					</li>
				</ul>
			</li>

			<li class="item">
				<div class="submenu-item <?php echo basename($_SERVER['PHP_SELF']) == 'manage-candidate.php' ? 'active' : ''; ?>"
				...
				<ul class="menu-items submenu collapse" id="manageCandidates">
					<li class="item">
						<a href="manage-acc.php"
							class="<?php echo basename($_SERVER['PHP_SELF']) == 'add-candidate.php' ? 'active-sub fw-bold' : ''; ?>">Add Candidate</a>
					</li>
					<li class="item">
						<a href="admin-creation.php"
							class="<?php echo basename($_SERVER['PHP_SELF']) == 'manage-candidate.php' ? 'active-sub fw-bold' : ''; ?>">Manage Candidates</a>
					</li>
				</ul>
			</li>
