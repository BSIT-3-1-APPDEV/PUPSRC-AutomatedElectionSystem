...
<head>
    ...
    <link rel="icon" href="images/logos/jmap.png" type="image/png">
    <title>JMAP Login</title>
</head>

<body class="login-body" id="JMAP-body">
    <div class="container-fluid">
        <div class="row">
            <div class="col login-left-section">
                <div class="organization-names">
                    <img src="images/logos/jmap.png" class="img-fluid login-logo" alt="JMAP Logo">
                    <p>JUNIOR MARKETING ASSOCIATION <br> OF THE PHILIPPINES</p>
                    <h1 class="login-AES">AUTOMATED ELECTION SYSTEM</h1>

                    <div class="login-wave-footer" id="JMAP-wave">
                ...
                <div>
                    <form action="" class="login-form">
                        ...
                        <div class="d-grid gap-2 mt-5 mb-4">
                            <a href="jmapDashboard.html" class="btn login-sign-in-button" id="JMAP-login-button" type="button">Sign In</a>
                        </div>

                        <p>Don’t have an account? <a href="jmapRegistrationPage" id="jmapSignUP">Sign Up</a></p>
