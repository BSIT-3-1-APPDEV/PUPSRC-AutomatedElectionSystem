...
<head>
    ...
    <link rel="icon" href="images/logos/give.png" type="image/png">
    <title>GIVE Login</title>
</head>

<body class="login-body" id="GIVE-body">
    <div class="container-fluid">
        <div class="row">
            <div class="col login-left-section">
                <div class="organization-names">
                    <img src="images/logos/give.png" class="img-fluid login-logo" alt="GIVE Logo">
                    <p>GUILD OF IMPOROUS AND <br> VALUABLE EDUCATORS</p>
                    <h1 class="login-AES">AUTOMATED ELECTION SYSTEM</h1>

                    <div class="login-wave-footer" id="GIVE-wave">
                ...
                <div>
                    <form action="" class="login-form">
                        ...
                        <div class="d-grid gap-2 mt-5 mb-4">
                            <a href="giveDashboard.html" class="btn login-sign-in-button" id="GIVE-login-button" type="button">Sign In</a>
                        </div>

                        <p>Don’t have an account? <a href="giveRegistrationPage" id="giveSignUP">Sign Up</a></p>
