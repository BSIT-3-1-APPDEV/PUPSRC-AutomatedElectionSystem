...
<head>
    ...
    <link rel="icon" href="images/logos/aeces.png" type="image/png">
    <title>AECES Login</title>
</head>

<body class="login-body" id="AECES-body">
    <div class="container-fluid">
        <div class="row">
            <div class="col login-left-section">
                <div class="organization-names">
                    <img src="images/logos/aeces.png" class="img-fluid login-logo" alt="AECES Logo">
                    <p>ASSOCIATION OF ELECTRONICS AND <br>COMMUNICATIONS ENGINEERING STUDENTS</p>
                    <h1 class="login-AES">AUTOMATED ELECTION SYSTEM</h1>

                    <div class="login-wave-footer" id="AECES-wave">
                ...
                <div>
                    <form action="" class="login-form">
                        ...
                        <div class="d-grid gap-2 mt-5 mb-4">
                            <a href="aecesDashboard.html" class="btn login-sign-in-button" id="AECES-login-button" type="button">Sign In</a>
                        </div>

                        <p>Don’t have an account? <a href="aecesRegistrationPage" id="aecesSignUP">Sign Up</a></p>
