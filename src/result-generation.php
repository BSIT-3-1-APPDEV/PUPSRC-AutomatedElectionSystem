                        ...
                        if ($result) {
                            if ($result->num_rows > 0) {
                                ...
                                while ($candidate_data = $result->fetch_assoc()) {
                                    ...
                                    $vote_count_query = $connection->query("SELECT COUNT(*) as vote_count FROM vote WHERE candidate_id = $candidate_id");
                                    $vote_result = $vote_count_query->fetch_assoc();
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-12 col-lg-12 mx-auto">
                                                <div class="card card-candidate card-candidate mb-4">
                                                    ...
                                                    <img src="<?php echo $candidate_data["photo_url"]; ?>" class="org-logo" alt="Candidate Image">
