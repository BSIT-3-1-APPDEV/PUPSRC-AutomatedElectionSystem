...
<body>
    ...
    <div class="container-fluid">
        <div class="row mt-5">
            <div class="col-md-6">
            <form id="register-form" action="includes/registration-process.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-12 d-flex justify-content-end">
                            <div class="col-7">
                                ...
                                <button class="btn btn-primary px-sm-5 py-sm-1-5 btn-sm fw-bold fs-6 spacing-6 w-100"
                                    type="submit" id="sign-up" name="sign-up" value="approve" disabled>Sign Up</button>
</div>
						...
						<div class="text-center">
							...
							<div class="row">
								<div class="col-md-12 pb-3">
									...
									<p class="fw-medium spacing-5">We'll notify you via email once your account has been verified and is ready for access.
									</p>
								</div>
							</div>
						</div>
