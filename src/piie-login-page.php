...
<head>
    ...
    <link rel="icon" href="images/logos/piie.png" type="image/png">
    <title>PIIE Login</title>
</head>

<body class="login-body" id="PIIE-body">
    <div class="container-fluid">
        <div class="row">
            <div class="col login-left-section">
                <div class="organization-names">
                    <img src="images/logos/piie.png" class="img-fluid login-logo" alt="PIIE Logo">
                    <p>PHILIPPINE INSTITUTE OF <br> INDUSTRIAL ENGINEERS</p>
                    <h1 class="login-AES">AUTOMATED ELECTION SYSTEM</h1>

                    <div class="login-wave-footer" id="PIIE-wave">
                ...
                <div>
                    <form action="" class="login-form">
                        ...
                        <div class="d-grid gap-2 mt-5 mb-4">
                            <a href="piieDashboard.html" class="btn login-sign-in-button" id="PIIE-login-button" type="button">Sign In</a>
                        </div>

                        <p>Don’t have an account? <a href="piieRegistrationPage" id="piieSignUP">Sign Up</a></p>
