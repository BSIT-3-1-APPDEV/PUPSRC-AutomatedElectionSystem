...
<head>
    ...
    <link rel="icon" href="images/logos/jpia.png" type="image/png">
    <title>JPIA Login</title>
</head>

<body class="login-body" id="JPIA-body">
    <div class="container-fluid">
        <div class="row">
            <div class="col login-left-section">
                <div class="organization-names">
                    <img src="images/logos/jpia.png" class="img-fluid login-logo" alt="JPIA Logo">
                    <p>JUNIOR PHILIPPINE INSTITUTE OF<br> ACCOUNTANTS</p>
                    <h1 class="login-AES">AUTOMATED ELECTION SYSTEM</h1>

                    <div class="login-wave-footer" id="JPIA-wave">
                ...
                <div>
                    <form action="" class="login-form">
                        ...
                        <div class="d-grid gap-2 mt-5 mb-4">
                            <a href="jpiaDashboard.html" class="btn login-sign-in-button" id="JPIA-login-button" type="button">Sign In</a>
                        </div>

                        <p>Don’t have an account? <a href="jpiaRegistrationPage" id="jpiaSignUP">Sign Up</a></p>
