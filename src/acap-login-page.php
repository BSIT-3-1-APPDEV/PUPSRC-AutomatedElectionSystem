...
<head>
    ...
    <link rel="icon" href="images/logos/acap.png" type="image/png">
    <title>ACAP Login</title>
</head>

<body class="login-body" id="ACAP-body">
    <div class="container-fluid">
        <div class="row">
            <div class="col login-left-section">
                <div class="organization-names">
                    <img src="images/logos/acap.png" class="img-fluid login-logo" alt="ACAP Logo">
                    <p>ASSOCIATION OF COMPETENT AND<br> ASPIRING PSYCHOLOGISTS</p>
                    <h1 class="login-AES">AUTOMATED ELECTION SYSTEM</h1>

                    <div class="login-wave-footer" id="ACAP-wave">
                ...
                <div>
                    <form action="" class="login-form">
                        ...
                        <div class="d-grid gap-2 mt-5 mb-4">
                            <a href="acapDashboard.html" class="btn login-sign-in-button" id="ACAP-login-button" type="button">Sign In</a>
                        </div>

                        <p>Don’t have an account? <a href="acapRegistrationPage" id="acapSignUP">Sign Up</a></p>
